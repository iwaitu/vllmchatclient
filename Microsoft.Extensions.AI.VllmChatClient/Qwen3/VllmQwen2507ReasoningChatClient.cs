...
{
    public class VllmQwen2507ReasoningChatClient : IChatClient
    {
        ...
        public VllmQwen2507ReasoningChatClient(string endpoint, string? token = null, string? modelId = "qwen3", HttpClient? httpClient = null)
        {
