...
namespace VllmChatClient.Test
{
    public class Nemotron3Tests
    {
        ...
        public Nemotron3Tests(ITestOutputHelper output)
        {
            var cloud_apiKey = Environment.GetEnvironmentVariable("OPEN_ROUTE_API_KEY");
            ...
            _client = new VllmNemotronChatClient("https://openrouter.ai/api/v1", cloud_apiKey);
            _output = output;
        }
