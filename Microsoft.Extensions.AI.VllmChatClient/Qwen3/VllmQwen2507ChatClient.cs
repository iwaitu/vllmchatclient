...
{
    public class VllmQwen2507ChatClient : IChatClient
    {
        ...
        public VllmQwen2507ChatClient(string endpoint, string? token = null, string? modelId = "qwen3", HttpClient? httpClient = null)
        {
